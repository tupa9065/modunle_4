...
public class ProvinceController {
    ...
    @PostMapping("/save")
    public ModelAndView createNew (@ModelAttribute Province province) throws DuplicateEmailException {
    ...
    @PostMapping("/edit")
    public ModelAndView edit (@ModelAttribute Province province) throws DuplicateEmailException {
